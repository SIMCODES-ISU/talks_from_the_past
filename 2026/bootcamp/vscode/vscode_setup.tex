...
}
{
    ...
    \includegraphics[height=0.50\textheight,keepaspectratio]{fig/vscode_extensions_python.png}\includegraphics[height=0.50\textheight,keepaspectratio]{fig/vscode_extensions_other.png}
    \end{center}
}
{}
