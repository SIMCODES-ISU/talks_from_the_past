...
\begin{itemize}
	...
	\item Add a link to the documentation.
	\item Add installation instructions.
	\item Write ``This is a change so I can learn GitHub.''
\end{itemize}
}}
{\AddPicture{readme.png}}
{}

\TwoColumnSlide{Step 0: Get a Repo}
{\BulletList{
\item Open command palette (ctrl+shift+P or cmd+shift+P).
\item Type ``git:clone''
\item Select ``Clone from github.''
\item Pick your project or ``SIMCODES-ISU/atom2seq''
}}
{\AddPicture{clone_from_github.png}}
{}
